...
const pokemon: PokemonListItem[] = [
    { id: 1, name: "bulbasaur", types: ["grass", "poison"], generation: 1, evolutionChainId: 1, sprite: "" },
    { id: 2, name: "ivysaur", types: ["grass", "poison"], generation: 1, evolutionChainId: 1, sprite: "" },
    { id: 3, name: "venusaur", types: ["grass", "poison"], generation: 1, evolutionChainId: 1, sprite: "" },
    ...
    { id: 6, name: "charizard", types: ["fire", "flying"], generation: 1, evolutionChainId: 2, sprite: "" },
